...
let hepein = Math.floor(Math.random() * 4000)
let expp = Math.floor(Math.random() * 5000)

  global.db.data.users[m.sender].limit += dia
  global.db.data.users[m.sender].money += hepein
...
await conn.sendButton(m.chat, texto, wm, img, [['《𝗩𝗼𝗹𝘃𝗲𝗿 𝗮𝗹 𝗠𝗲𝗻𝘂》', '/menu'] ], null, null, fkontak)  
