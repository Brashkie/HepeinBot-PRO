...
// Imágenes de Bot especial mes de navidad
let img = ['https://qu.ax/BRPlC.jpg', 'https://qu.ax/cQgSx.jpg', 'https://qu.ax/CloBa.jpg', 'https://qu.ax/hFrDe.jpg', 'https://qu.ax/yYMWU.jpg', 'https://qu.ax/AcWzS.jpg'].getRandom()

await conn.sendFile(m.chat, img, 'navidad.jpg', `${text}\n${texto}`, m, null, fake)
user.lastclaim = new Date * 1
}
handler.command = ['navidad1', 'navidad2', 'christmas'] 
handler.level = 3
