...
await conn.sendMessage(m.chat, { image: { url: yt_play[0].thumbnail }, caption: gt, footer: texto1,buttons: [{ buttonId: `.ytmp3 ${yt_play[0].url}`, buttonText: { displayText: "𒁈 𝔸𝕌𝔻𝕀𝕆 𒁈" }, type: 1 }, { buttonId: `.ytmp4 ${yt_play[0].url}`, buttonText: { displayText: "𒁈 𝕍𝕀𝔻𝔼𝕆 𒁈" }, type: 1 }], viewOnce: true, headerType: 4 }, { quoted: m });
}};
