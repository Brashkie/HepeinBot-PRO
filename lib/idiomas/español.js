...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `╰𒉺✅𒉺 *RESULTADO* 𒉺✅𒉺╮\n\n` } 
const smsAvisoAG = () => { return `╰𒉺⚠️𒉺 *ADVERTENCIA* 𒉺⚠️𒉺╮\n\n` }
const smsAvisoIIG = () => { return `╰𒉺❕𒉺 *INFORMACIÓN* 𒉺❕𒉺╮\n\n` }
const smsAvisoFG = () => { return `╰𒉺❌𒉺 *ERROR* 𒉺❌𒉺╮\n\n` }
const smsAvisoMG = () => { return `╰𒉺❗️𒉺 *ACCIÓN MAL USADA* 𒉺❗️𒉺╮\n\n` }
const smsAvisoEEG = () => { return `╰𒉺📩𒉺 *REPORTE* 𒉺📩𒉺╮\n\n` }
const smsAvisoEG = () => { return `╰𒉺💚𒉺 *ÉXITO* 𒉺💚𒉺╮\n\n` }
...
const smsLista1 = () => { return `𒁈 INFORMACIÓN DE HEPEINBOT 𒁈`}
...
const smsLista18 = () => { return `𒁈 MULTIMEDIA 𒁈`}
...
const smsLista23 = () => { return `𒁈 DIVERSIÓN 𒁈`}
...
const smsLista31 = () => { return `𒁈 AJUSTES 𒁈`}
...
const smsBye = () => { return '*╔══════『 EXPULSADO 』══*\n┃ @user\n┃ *NO LE SABE AL GRUPO, CHAO!!*\n*╚═════════════════════〘♡〙*'}
const smsSpromote = () => { return '*@user AHORA ES ADMIN DE ESTE GRUPO!!*'}
const smsSdemote = () => { return '*@user DEJA DE SER ADMIN EN ESTE GRUPO!!*'}
const smsSdesc = () => { return '*NUEVA DESCRIPCION DE ESTE GRUPO ES:*\n\n@desc'}
const smsSsubject = () => { return '*NUEVO NOMBRE DEL GRUPO ES:*\n\n@subject'}
const smsSicon = () => { return '*SE HA REEMPLAZADO EL ICONO DEL GRUPO*'}
const smsSrevoke = () => { return '*ACTUAL, NUEVO ENLACE DEL GRUPO!!*\n\n*@revoke*'}
const smsConexion = () => { return `\n»»------(¯ CONEXIÓN EXITOSA ¯)------« «\n│\n│🟢 WhatsApp conectado.\n│\n│😎 El bot está online y más despierto que tú.\n│\n│📶 No hay excusas, ¡a trabajar!\n│\n𓃠 ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✦ ✅ ✦┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 𓃠`} 
const smsCargando = () => { return `𒁈 CARGANDO...\n`} 
...
//_allantilink.js
const smsTextoYT = () => { return ' 𝗛𝗲𝗽𝗲𝗶𝗻𝗕𝗼𝘁-𝗣𝗥𝗢 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
const smsApagar = () => { return '✘ DESACTIVAR'} 
const smsEncender = () => { return '✔ ACTIVAR'} 
const smsEnlaceTik = () => { return `> ⚑ SE DETECTO UN ENLACE PROHIBIDO DE TIKTOK EN ESTE GRUPO\n\nPROCEDO A ELIMINARTE ✖`}
const smsEnlaceYt = () => { return `> ⚑ SE DETECTO UN ENLACE PROHIBIDO DE YOUTUBE EN ESTE GRUPO\n\nPROCEDO A ELIMINARTE ✖`}
const smsEnlaceTel = () => { return `> ⚑ SE DETECTO UN ENLACE PROHIBIDO DE TELEGRAM EN ESTE GRUPO\n\nPROCEDO A ELIMINARTE ✖`}
const smsEnlaceFb = () => { return `> ⚑ SE DETECTO UN ENLACE PROHIBIDO DE FACEBOOK EN ESTE GRUPO\n\nPROCEDO A ELIMINARTE ✖`}
const smsEnlaceIg = () => { return `> ⚑ SE DETECTO UN ENLACE PROHIBIDO DE INSTAGRAM EN ESTE GRUPO\n\nPROCEDO A ELIMINARTE ✖`}
const smsEnlaceTw = () => { return `> ⚑ SE DETECTO UN ENLACE PROHIBIDO DE TWITER EN ESTE GRUPO\n\nPROCEDO A ELIMINARTE ✖`}
const smsAllAdmin = () => { return `> ⚑ DEBO DE SER ADMIN PARA PODER ELIMINAR A INTRUSOS(AS)`}
const smsSoloOwner = () => { return `> ⚑ EL PROPIETARIO DEBE ACTIVAR ESTA FUNCION\n> *#on restrict*`}
...
const smsCont15 = () => { return `HOLA!! 🥳`}
const smsCont16 = () => { return `LAS LLAMADAS 📲`}
const smsCont17 = () => { return `LAS LLAMADAS 📞`}
const smsCont18 = () => { return `NO ESTAN AUTORIZADAS POR LO QUE TENDRE QUE BLOQUEARTE\n\nSI LLAMASTE POR ACCIDENTE COMUNICATE CON LA PERSONA PROPIETARIO(A) DE ESTE BOT\nSI ES UNA CUENTA OFICIAL DE HEPEIN DIRIGETE A LA ASISTENCIA POR INSTAGRAM PARA TRATAR SU CASO\n*${global.ig}*`}
const smsCont19 = () => { return `ANTI ELMINAR`}
const smsCont20 = () => { return `*┃✤ Nombre:*`}
const smsCont21 = () => { return `*┃✤ Enviando el mensaje eliminado...*`}

//_anti-internacional.js
const smsInt1 = () => { return `ESTE NUMERO`}
const smsInt2 = () => { return `NO ESTA PERMITIDO EN ESTE GRUPO!!`}

//_antilink.js
const smsAdwa = () => { return `${global.lenguajeGB['smsAvisoEG']()}COMO ERES ADMIN EN ESTE GRUPO NO SERAS ELMINADO(A)`}
const smsEnlaceWat = () => { return `${lenguajeGB['smsAvisoAG']()}> ⚑ SE DETECTO UN ENLACE PROHIBIDO DE WHATSAPP EN ESTE GRUPO\n\nBRASHKIE NO PERDONA CHAO`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeGB['smsAvisoAG']()}> ⚑ SE DETECTO UN ENLACE PROHIBIDO QUE CONTIENE HTTPS EN ESTE GRUPO\n\nBRASHKIE NO PERDONA CHAO`}
...
//Texto
const smsConMenu = () => { return `━═▣ 𝗠 𝗘 𝗡 𝗨`} //🟡 NO CAMBIAR 
...
//_antitoxic.js
const smsToxic1 = () => { return `😒 𝙐𝙁... 𝙌𝙐𝙀 𝙀𝙇𝙀𝙂𝘼𝙉𝘾𝙄𝘼 𝙇𝘼 𝙏𝙐𝙔𝘼`}
const smsToxic2 = () => { return `𝙀𝙎𝙏𝘼 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝘼 𝙉𝙊 𝙎𝙀𝘼𝙎 𝙏𝙊𝙓𝙄𝘾𝙊(𝘼)`}
const smsToxic3 = () => { return `*ADVERTENCIA*\n⚠️`}
const smsToxic4 = () => { return `LO SIENTO (︶^︶)`} //🟡 NO CAMBIAR 
const smsToxic5 = () => { return `DESACTIVAR ANTITOXIC`} //🟡 NO CAMBIAR 
const smsToxic6 = () => { return `TE LO ADVERTI VARIAS VECES!!`}
const smsToxic7 = () => { return `SUPERASTES LOS 4 ADVERTENCIA, AHORA SERAS ELIMINADO(A)`}
...
const eCoins = () => { return '💵 Coins' }
const eTickers = () => { return '🎫 Tickets' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar HepeinBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar HepeinBot en Grupos`}
const smsLect1 = () => { return `✅ LECTURA AUTOMÁTICA`}
const smsLect2 = () => { return `Dejar los mensajes o chats como Leídos`}
const smsTempo1 = () => { return `𒁈 BOT TEMPORAL`}
...
//_antiviewonce.js
const smsAntiView = () => { return `*𝙈𝘼𝙎𝙏𝙀𝙍, 𝙉𝙊 𝙃𝘼𝙔 𝙀𝙎𝘾𝘼𝙋𝙀... 𝙇𝙊 𝙑𝙀𝙊 𝙏𝙊𝘿𝙊* 👁️`} 
...
//grupo-tagall.js
const smstagaa = () => { return `✨ *¡TÉCNICA SECRETA | INVOCACIÓN GRUPAL!* ✨`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n*━═▣ 𝗛𝗲𝗽𝗲𝗶𝗻𝗕𝗼𝘁-𝗣𝗥𝗢 ▣═━* es un bot de WhatsApp que te ayudará a realizar diferentes actividades 🪄 tanto en privado como en grupo\n¡También te vas a divertir con sus múltiples funciones!, disfruta del Hepein Oficial!!! \n\n➽ HEPEINBOT fue invatada por:\n@${user}`}
...
const smsPropban5 = () => { return `${lenguajeGB['smsAvisoEG']()}🚫 El/la usuario(a) ha sido *baneado(a)*\nNo podrá usar a ${gt}`}
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: electronicatodo2006@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de HepeinBot'}
...
smsContacto5, smsContacto6, smsContacto7, smsContacto8, smsAfkQ1, smsAfkQ2, smsAfkTime, smsMainBot, smsLisF, smsLisG, smsIniJadi2, smsJBConexionClose2, smsreenvia
}
