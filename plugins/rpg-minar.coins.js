...
let pp = 'https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2019/05/terminator.jpg?tf=3840x'
...
await conn.sendFile(m.chat, pp, 'Bras.jpg', gat, fkontak)

user.lastcoins = new Date * 1  
}
handler.help = ['minar2']
handler.tags = ['bras']
handler.command = ['minar2', 'miming2', 'mine2', 'minarcoins', 'minarcoins', 'minarbras'] 
handler.fail = null
handler.exp = 0
