...
let pp = 'https://c4.wallpaperflare.com/wallpaper/39/346/426/digital-art-men-city-futuristic-night-hd-wallpaper-preview.jpg'
let hepein = Math.floor(Math.random() * 3000)
global.db.data.users[m.sender].exp += hepein * 1  
...
await conn.reply(m.chat, `*${pickRandom(global.work)}* ${hepein} XP`, fkontak, pp, m)
