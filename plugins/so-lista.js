...
if (chat.audios && m.text.match(/(admin|tengo|calzon|boxer)/gi)){
let vn = 'https://qu.ax/wlmHu.mp3'
this.sendPresenceUpdate('recording', m.chat)
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp3', mimetype: 'audio/mp4', ptt: true }, { quoted: m})}

if (chat.audios && m.text.match(/(😹|JAJAJAJA|jajaja|🤣|😂)/gi)){
let vn = 'https://qu.ax/mwdf.mp3'
this.sendPresenceUpdate('recording', m.chat)
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp3', mimetype: 'audio/mp4', ptt: true }, { quoted: m})}

if (chat.audios && m.text.match(/(😸|😅|😄)/gi)){
let vn = 'https://qu.ax/cdTNl.mp3'
this.sendPresenceUpdate('recording', m.chat)
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp3', mimetype: 'audio/mp4', ptt: true }, { quoted: m})}

if (chat.audios && m.text.match(/(Onichan|Oniiii|bro|brother|chan|mano|onichan|oni|oni-chan)/gi)){
