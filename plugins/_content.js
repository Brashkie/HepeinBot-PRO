...
let enlace = { contextInfo: { externalAdReply: {title: wm + ' 𒁈', body: 'support group' , sourceUrl: redesMenu, thumbnail: await(await fetch(BrasMenu)).buffer() }}}
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '━═▣ 𝗛𝗲𝗽𝗲𝗶𝗻𝗕𝗼𝘁-𝗣𝗥𝗢 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: BrasMenu, sourceUrl: accountshb }}}
...
global.canalNombreHB = ["𒅒𝗕𝗿𝗮𝘀𝗵𝗸𝗶𝗲 𝗡𝗮𝗿𝗶𝘂𝗿𒅒", "𒅒𝗕𝗿𝗮𝘀𝗵𝗸𝗶𝗲 𝗡𝗮𝗿𝗶𝘂𝗿𒅒", "𒅒𝗕𝗿𝗮𝘀𝗵𝗸𝗶𝗲 𝗡𝗮𝗿𝗶𝘂𝗿𒅒", "𒅒𝗕𝗿𝗮𝘀𝗵𝗸𝗶𝗲 𝗡𝗮𝗿𝗶𝘂𝗿𒅒"]
