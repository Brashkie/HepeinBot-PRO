// 🔞 Comando creado por BrashkieBot
import fetch from 'node-fetch';

const handler = async (conn, m, { command }) => {
    const textoCargando = `⌛ _Cargando..._\n▰▰▰▱▱▱▱▱▱\n> *${command}*`;

    // Envía mensaje de texto "Cargando..."
    await conn.sendMessage(m.chat, { text: textoCargando }, { quoted: m });
...
handler.command = [
    ...
    'pornolesbivid', 'pornolesbianavid',
    'pornolesbiv', 'pornolesbianav', 'pornolesv','packgirl','videosxxxc2','videosxxxc','packmen'
];
handler.group = true;
