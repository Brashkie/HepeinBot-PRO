...
_2.Top Coins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🤖 Minar Coins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
...
*╰─⋆─⋆─⋆─⋆─⋆─⋆─⋆─⋆─┄⸙*`.trim()//`
conn.sendFile(m.chat, imgr, 'bras.jpg', caption, fkontak, m, { mentions: conn.parseMention(caption) })
...
conn.sendFile(m.chat, imgr, 'bras.jpg', str, {quoted: fkontak})
...
conn.sendFile(m.chat, imgr, 'bras.jpg', str, fkontak, m, { mentions: conn.parseMention(str) })
...
┃💐 *Caja de Jardinería : Garden boxs » ${user.gardenboxs}*
╰━━━━━━━━━⬣`.trim()
conn.sendFile(m.chat, imgr, 'bras.jpg', aineh, fkontak, m)}
